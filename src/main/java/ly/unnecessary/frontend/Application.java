...
public class Application extends javafx.application.Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        var community1 = this.createCommunityLink("FP", true, "Felicitas Pojtinger's Community");
        ...
        var avatarHeader = new Button("FP Felicitas Pojtinger");
    ...
    private HBox createHeader() {
        ...
        var avatarName = new Label("Felicitas Pojtinger");
